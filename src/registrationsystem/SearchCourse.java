...
public class SearchCourse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("By Department and Instructor");
        ...
        jButton2.setText("By Day and Period ");
    ...
    SearchByDep_Inst s=new SearchByDep_Inst();
    s.setVisible(true);
    this.setVisible(false);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
    SearchByDay_Period s=new SearchByDay_Period();
    s.setVisible(true);
    this.setVisible(false);
